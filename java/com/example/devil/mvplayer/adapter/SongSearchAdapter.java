...
/**
 * Created by whizkraft on 14/5/18.
 */
...
public class SongSearchAdapter extends RecyclerView.Adapter<SongSearchAdapter.MyViewHolder> {
    ...
    public SongSearchAdapter(Activity activity,ArrayList<SubCategoryGetter>categorylist,OnRecyclerViewItemClickListener onRecyclerViewItemClickListener){
    ...
    @Override
    public SongSearchAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_all_songs, null);
        return new SongSearchAdapter.MyViewHolder(view);


    }

    @Override
    public void onBindViewHolder(SongSearchAdapter.MyViewHolder holder, final int position) {
