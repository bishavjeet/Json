...
/**
 * Created by Devil on 3/25/2018.
 */

public class AllSongFrag extends Fragment {
  ...
  // ProgressDialog progressDialog;
    ...
    private void init(View layout) {
        ...
        String url = Config.getSeeAll + "&cId=" + LdPreferences.readString(activity, "CID");
    ...
    public class Test extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            Log.e("response ", "Song response--" + response);
