            ...
            try {
                ...
                if (code.equalsIgnoreCase("1")) {
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        String subid = jsonObject3.getString("id");
                        String subname = jsonObject3.getString("name");
                        String songurl = jsonObject3.getString("location");
                        String releasedate = jsonObject3.getString("releaseDate");
                        String status = jsonObject3.getString("status");
                        String image = jsonObject3.getString("Image");
                        String songid = jsonObject3.getString("song_id");
